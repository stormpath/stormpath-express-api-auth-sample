...
html(class='no-js', lang='en')
  ...
  head
    ...
    style.
      ...
      body {
        height: 100%;
        background-image:url('http://www.walldesktops.com/wp-content/uploads/2013/05/San-Francisco-Wallpaper-44.jpg');
      }
      ...
      .registration-view .box { background: #fff !important; }
